...
const Header = () => {
  ...
  <button className='bg-(--purple) hover:bg-[#5f0df8cc] rounded-full cursor-pointer font-medium px-6 text-white py-3.5 text-center  mr-4'>Partner with Us</button>
    ...
    <div className='flex flex-col text-(--gray) h-[70vh] space-y-2 font-semibold bg-(--gray-200) items-center'>
      ...
      <button className='bg-(--purple) hover:bg-[#5f0df8cc] rounded-full cursor-pointer font-medium mx-9 w-150 p-3.5 mb-5 text-white text-center'>Partner with Us</button>
    </div>
